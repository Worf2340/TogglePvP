...
public class SQLite extends Database {
    ...
    public SQLite(TogglePvP instance) {
        super(instance);
        dbname = plugin.getConfig().getString("SQLite.Filename", "pvp_list"); // Set the table name here e.g player_kills
    }

    public String SQLiteCreateTokensTable = "CREATE TABLE IF NOT EXISTS pvp_list (" + // make sure to put your table name in here too.
